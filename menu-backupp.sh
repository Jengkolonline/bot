...
Name=$(curl https://raw.githubusercontent.com/Jengkolonline/izinn/main/ip | grep $MYIP | awk '{print $2}')
...
botbckpBot_menu() {
	...
	echo -e " ${Blue}╰═══════════════════════════════════════════════════════╯${NC}"
    echo -e " ${Blue}╭═══════════════════════════════════════════════════════╮${NC}"
    echo -e " ${Blue}│$NC ${green} VPS Data Backup By JengkolOnline Tunneling"
    echo -e " ${Blue}│$NC"
